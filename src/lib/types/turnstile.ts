/**
 * @see {@link https://github.com/marsidev/react-turnstile/blob/main/packages/lib/src/types.ts}
 */
...
type ContainerSizeSet = {
  [size in
    | NonNullable<ComponentRenderOptions['size']>
    | 'interactionOnly']: React.CSSProperties
}
